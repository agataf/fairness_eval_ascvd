...
from fairness_ascvd.prediction_utils.pytorch_utils.metric_logging import MetricLogger
from fairness_ascvd.prediction_utils.pytorch_utils.layers import (
    SparseLinear,
    LinearLayer,
    SequentialLayers,
    FeedforwardNet,
...
from fairness_ascvd.prediction_utils.pytorch_utils.pytorch_metrics import weighted_cross_entropy_loss
...
class TorchModel:
    ...
    def init_metric_comparator(self):
        ...
        """
        if "loss" in self.config_dict["selection_metric"]:
